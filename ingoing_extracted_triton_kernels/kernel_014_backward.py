# Original file: xq/cxqq7vkjsuednzxljrgkqqgokj7diak2xqlfaapxzxilxaj6k3bd.debug/output_code.py
# Type: Backward
...
# kernel path: /tmp/triton_kernels_6xj62som/e2/ce2m7s4b24gddyxrex4dz4y4irf44gypfmyugi3cja4vdn6gz6j5.py
...
# kernel path: /tmp/triton_kernels_6xj62som/tl/ctl4xa4qm2uqdmteln3b54r43jgqfphfwxage7m2a3wrrh32mjnx.py
# Topologically Sorted Source Nodes: [], Original ATen: [aten.sum]
# Source node to ATen node mapping:
#   %sum_1 : [num_users=1] = call_function[target=torch.ops.aten.sum.dim_IntList](args = (%view_20, [0], True), kwargs = {})
...
# kernel path: /tmp/triton_kernels_6xj62som/t7/ct7tzllayasu44fn3b5jpbkjxtgirendwxniyewsrksw6hq6wf4s.py
...
# kernel path: /tmp/triton_kernels_6xj62som/tm/ctm6fgpbc4wez4c7yy5yjzal6nrim44ucg53utsaeswuzu2cblwb.py
...
def triton_red_fused_mul_native_layer_norm_backward_sigmoid_3(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, out_ptr0, out_ptr1, xnumel, r0_numel, XBLOCK : tl.constexpr, R0_BLOCK : tl.constexpr):
    ...
    for r0_offset in range(0, r0_numel, R0_BLOCK):
        ...
        tmp5 = tl.load(in_ptr3 + (31360*((r0_2 + 236*x1) // 31329) + (((r0_2 + 236*x1) % 31329))), xmask & r0_mask, eviction_policy='evict_last', other=0.0)
        tmp7 = tl.load(in_ptr4 + (31360*((r0_2 + 236*x1) // 31329) + (((r0_2 + 236*x1) % 31329))), xmask & r0_mask, eviction_policy='evict_last', other=0.0)
        tmp2 = tl.sigmoid(tmp1)
        tmp3 = tmp0 * tmp2
        tmp6 = tmp4 - tmp5
        tmp8 = tmp6 * tmp7
...
# kernel path: /tmp/triton_kernels_6xj62som/ca/ccaoosvtlhm5hxv47fvvrmvcbiwvwzlacqgshbpyoltzabjb2tcv.py
...
# kernel path: /tmp/triton_kernels_6xj62som/2x/c2xi7uw63twu32y2j2eljrr4psrfhej4wzoajzymhswp62mgv5tv.py
...
@triton_heuristics.pointwise(
    ...
    inductor_meta={'grid_type': 'Grid2DWithYZOverflow', 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_clone_mul_sigmoid_sigmoid_backward_5', 'mutated_arg_names': ['in_out_ptr0'], 'optimize_mem': True, 'no_x_dim': False, 'num_load': 4, 'num_reduction': 0, 'backend_hash': '2B4DCE383ADC6F6AC9E37B7BE08352A0B047033492CBA4C9904681B32954FEA9', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False},
    min_elem_per_thread=0
)
@triton.jit
...
# kernel path: /tmp/triton_kernels_6xj62som/ml/cmluyqudmh4d3ihxalltexzfrd65yvgsrk2yxhghxv6hnxzxyqo2.py
...
@triton_heuristics.pointwise(
    ...
    filename=__file__,
    triton_meta={'signature': {'in_out_ptr0': '*fp32', 'in_ptr0': '*fp32', 'in_ptr1': '*fp32', 'in_ptr2': '*fp32', 'out_ptr0': '*fp32', 'ynumel': 'i32', 'xnumel': 'i32', 'YBLOCK': 'constexpr', 'XBLOCK': 'constexpr'}, 'device': DeviceProperties(type='cuda', index=0, multi_processor_count=58, cc=89, major=8, regs_per_multiprocessor=65536, max_threads_per_multi_processor=1536, warp_size=32), 'constants': {}, 'configs': [{(0,): [['tt.divisibility', 16]], (1,): [['tt.divisibility', 16]], (2,): [['tt.divisibility', 16]], (3,): [['tt.divisibility', 16]], (4,): [['tt.divisibility', 16]], (6,): [['tt.divisibility', 16]]}]},
    inductor_meta={'grid_type': 'Grid2D', 'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_clone_mul_sigmoid_sigmoid_backward_6', 'mutated_arg_names': ['in_out_ptr0'], 'optimize_mem': True, 'no_x_dim': False, 'num_load': 4, 'num_reduction': 0, 'backend_hash': '2B4DCE383ADC6F6AC9E37B7BE08352A0B047033492CBA4C9904681B32954FEA9', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False},
    min_elem_per_thread=0
)
@triton.jit
def triton_poi_fused_clone_mul_sigmoid_sigmoid_backward_6(in_out_ptr0, in_ptr0, in_ptr1, in_ptr2, out_ptr0, ynumel, xnumel, YBLOCK : tl.constexpr, XBLOCK : tl.constexpr):
    ...
    tmp1 = tl.load(in_out_ptr0 + (x5 + 22656*y4), xmask & ymask, eviction_policy='evict_last')
    tmp2 = tl.load(in_ptr1 + (x3 + 177*y4), xmask & ymask, eviction_policy='evict_last')
    tmp5 = tl.load(in_ptr2 + (x5 + 22656*y4), xmask & ymask, eviction_policy='evict_last')
    tmp3 = tmp1 * tmp2
    tmp4 = tmp0 * tmp3
    tmp6 = tl.sigmoid(tmp5)
    tmp7 = 1.0
    ...
    tmp12 = tmp11 * tmp2
    tl.debug_barrier()
    tl.store(in_out_ptr0 + (x5 + 22656*y4), tmp10, xmask & ymask)
    tl.store(out_ptr0 + (x5 + 22656*y4), tmp12, xmask & ymask)
''', device_str='cuda')


# kernel path: /tmp/triton_kernels_6xj62som/xl/cxlhtymle7o7e2h6ul3jkspbp5tgkoeskmvr6tupdclljymoo5zm.py
...
def triton_red_fused_add_native_layer_norm_native_layer_norm_backward_7(in_out_ptr0, in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, in_ptr5, in_ptr6, in_ptr7, out_ptr2, xnumel, r0_numel, XBLOCK : tl.constexpr, R0_BLOCK : tl.constexpr):
    ...
    for r0_offset in range(0, r0_numel, R0_BLOCK):
        ...
        rindex = r0_index
        r0_1 = r0_index
        tmp0 = tl.load(in_out_ptr0 + (r0_1 + 128*x0), r0_mask & xmask, eviction_policy='evict_first', other=0.0)
        tmp1 = tl.load(in_ptr0 + (r0_1 + 128*x0), r0_mask & xmask, eviction_policy='evict_first', other=0.0)
        tmp3 = tl.load(in_ptr1 + (r0_1 + 128*x0), r0_mask & xmask, eviction_policy='evict_first', other=0.0)
        tmp5 = tl.load(in_ptr2 + (r0_1 + 128*x0), r0_mask & xmask, eviction_policy='evict_first', other=0.0)
        tmp7 = tl.load(in_ptr3 + (r0_1 + 128*x0), r0_mask & xmask, eviction_policy='evict_first', other=0.0)
        tmp9 = tl.load(in_ptr4 + (r0_1), r0_mask, eviction_policy='evict_last', other=0.0)
        tmp14 = tl.load(in_ptr5 + (r0_1 + 128*x0), r0_mask & xmask, eviction_policy='evict_last', other=0.0)
        tmp2 = tmp0 + tmp1
        tmp4 = tmp2 + tmp3
        tmp6 = tmp4 + tmp5
        tmp8 = tmp6 + tmp7
        ...
        tl.store(in_out_ptr0 + (r0_1 + 128*x0), tmp8, r0_mask & xmask)
    ...
    for r0_offset in range(0, r0_numel, R0_BLOCK):
        ...
        rindex = r0_index
        r0_1 = r0_index
        tmp25 = tl.load(in_out_ptr0 + (r0_1 + 128*x0), r0_mask & xmask, eviction_policy='evict_first', other=0.0)
        tmp26 = tl.load(in_ptr4 + (r0_1), r0_mask, eviction_policy='evict_last', other=0.0)
        tmp31 = tl.load(in_ptr5 + (r0_1 + 128*x0), r0_mask & xmask, eviction_policy='evict_first', other=0.0)
        tmp23 = 0.0078125
        tmp24 = tmp17 * tmp23
        tmp27 = tmp25 * tmp26
        tmp28 = 128.0
        ...
        tmp35 = tmp30 - tmp34
        tmp36 = tmp24 * tmp35
        tl.store(out_ptr2 + (r0_1 + 128*x0), tmp36, r0_mask & xmask)
''', device_str='cuda')


# kernel path: /tmp/triton_kernels_6xj62som/2u/c2unt5i6npswrapqirna7cqnd7mgnnpncbyh6x6rzhyzjdxrcxkg.py
...
def triton_red_fused_native_layer_norm_native_layer_norm_backward_8(in_ptr0, in_ptr1, in_ptr2, in_ptr3, out_ptr0, out_ptr1, xnumel, r0_numel, XBLOCK : tl.constexpr, R0_BLOCK : tl.constexpr):
    ...
    for r0_offset in range(0, r0_numel, R0_BLOCK):
        ...
        tmp0 = tl.load(in_ptr0 + (x0 + 128*r0_2 + 30208*x1), xmask & r0_mask, eviction_policy='evict_first', other=0.0)
        tmp1 = tl.load(in_ptr1 + (x0 + 128*r0_2 + 30208*x1), xmask & r0_mask, eviction_policy='evict_first', other=0.0)
        tmp2 = tl.load(in_ptr2 + (31360*((r0_2 + 236*x1) // 31329) + (((r0_2 + 236*x1) % 31329))), xmask & r0_mask, eviction_policy='evict_last', other=0.0)
        tmp4 = tl.load(in_ptr3 + (31360*((r0_2 + 236*x1) // 31329) + (((r0_2 + 236*x1) % 31329))), xmask & r0_mask, eviction_policy='evict_last', other=0.0)
        tmp3 = tmp1 - tmp2
        tmp5 = tmp3 * tmp4
        tmp6 = tmp0 * tmp5
...
# Local Attention Backward BMM Kernel for TriangleMultiplicativeModule ingoing einsum
@triton.jit
def triton_local_attention_bmm_kernel(
    ...
    stride_grad_left_batch, stride_grad_left_k, stride_grad_left_m,
    stride_grad_right_batch, stride_grad_right_k, stride_grad_right_n,
    BLOCK_M: tl.constexpr, BLOCK_N: tl.constexpr, BLOCK_K: tl.constexpr,
    GROUP_M: tl.constexpr, grid_m: tl.constexpr, grid_n: tl.constexpr, ACC_TYPE: tl.constexpr = tl.float32
):
    """
    Computes gradients for left and right tensors with k range limited to window_size around i
    
    Forward: 
        out[i,j] = sum_k left[k,i] * right[k,j] where |i-k| <= window_size
    Backward: 
        grad_left[k,i] = sum_j grad_output[i,j] * right[k,j] where |i-k| <= window_size
        grad_right[k,j] = sum_i grad_output[i,j] * left[k,i] where |i-k| <= window_size
    """
    pid = tl.program_id(0)
    ...
    acc_grad_left = tl.zeros((BLOCK_K, BLOCK_M), dtype=ACC_TYPE)
    acc_grad_right = tl.zeros((BLOCK_K, BLOCK_N), dtype=ACC_TYPE)
    
    # Calculate the effective k range for this m block (local attention)
    ...
    for k_offset in range(k_start_block, k_end_block, BLOCK_K):
        if k_offset < K:
            ...
            # |m - k| <= window_size for local attention
            # Create mask in the correct shape (BLOCK_K, BLOCK_M) directly
            k_indices_col = k_indices[:, None]  # Shape: (BLOCK_K, 1)
            m_indices_row = ram[None, :]        # Shape: (1, BLOCK_M)
            local_mask = tl.abs(k_indices_col - m_indices_row) <= window_size
            ...
            # Combined masks
            km_mask = (k_mask[:, None] & m_mask[None, :]) & local_mask
            ...
            if remaining_k >= BLOCK_K:
                ...
                left_block = tl.load(left_ptr + left_ptrs, mask=km_mask, other=0.0)
                right_block = tl.load(right_ptr + right_ptrs, mask=kn_mask, other=0.0)
            else:
                # k boundary check
                k_boundary_mask = k_indices < K
                km_final_mask = km_mask & k_boundary_mask[:, None]
                kn_final_mask = kn_mask & k_boundary_mask[:, None]
                
                grad_output_block = tl.load(grad_output_ptr + grad_output_ptrs, mask=mn_mask, other=0.0)
                left_block = tl.load(left_ptr + left_ptrs, mask=km_final_mask, other=0.0)
                right_block = tl.load(right_ptr + right_ptrs, mask=kn_final_mask, other=0.0)
            
            # Compute gradients with local attention masking
            # grad_left[k,i] = sum_j grad_output[i,j] * right[k,j] where |i-k| <= window_size
            grad_left_update = tl.dot(right_block, grad_output_block.T, allow_tf32=True)
            acc_grad_left += tl.where(km_mask, grad_left_update, 0.0)
    ...
    km_store_mask = (rk[:, None] < K) & (ram[None, :] < M)
    tl.store(grad_left_ptr + grad_left_ptrs, acc_grad_left, mask=km_store_mask)
    
    # Store grad_right
    grad_right_ptrs = (pid_batch * stride_grad_right_batch + 
                      rk[:, None] * stride_grad_right_k + 
                      rbn[None, :] * stride_grad_right_n)
    kn_store_mask = (rk[:, None] < K) & (rbn[None, :] < N)
...
def launch_local_attention_backward_bmm_kernel(grad_output, left, right, grad_left, grad_right, window_size=16):
    """
        ...
        left: Left input tensor (batch_size, K, M)  - ingoing layout
        right: Right input tensor (batch_size, K, N)  - ingoing layout
        grad_left: Gradient of left tensor (batch_size, K, M)
        grad_right: Gradient of right tensor (batch_size, K, N)
        window_size: Local attention window size (default: 16)
    """
    batch_size, M, N = grad_output.shape
    _, K_left, M_left = left.shape
    _, K_right, N_right = right.shape
    K = K_left
    ...
    stride_left_batch, stride_left_k, stride_left_m = left.stride()
    stride_right_batch, stride_right_k, stride_right_n = right.stride()
    stride_grad_left_batch, stride_grad_left_k, stride_grad_left_m = grad_left.stride()
...
def call(args):
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        # Topologically Sorted Source Nodes: [right_1, right_gate], Original ATen: [aten.mul, aten.sigmoid, aten.sigmoid_backward, aten.clone]
        stream0 = get_raw_stream(0)
        triton_poi_fused_clone_mul_sigmoid_sigmoid_backward_5.run(buf18, buf11, bmm, addmm_3, buf28, 125316, 128, stream=stream0)
        del addmm_3
        ...
        # Topologically Sorted Source Nodes: [left_1, left_gate], Original ATen: [aten.mul, aten.sigmoid, aten.sigmoid_backward, aten.clone]
        stream0 = get_raw_stream(0)
        triton_poi_fused_clone_mul_sigmoid_sigmoid_backward_6.run(buf23, buf12, bmm, addmm_2, buf33, 708, 22656, stream=stream0)
        del addmm_2
        del bmm
